...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        System.out.println(getFilteredWithExceeded(mealList, LocalTime.of(10, 0), LocalTime.of(13,0), 2000));
//        System.out.println(getFilteredWithExceeded(mealList, LocalTime.of(10, 0), LocalTime.of(20,0), 2000));
    }
