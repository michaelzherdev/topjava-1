...
public class MealRestController {
    ...
    public List<MealWithExceed> getAllByUser() {
        log.info("getAllByUser");
        List<Meal> meals = service.getAllByUser(AuthorizedUser.id());
        return MealsUtil.getWithExceeded(meals, MealsUtil.DEFAULT_CALORIES_PER_DAY);
    }

    public List<MealWithExceed> getBetween(LocalDateTime startTime, LocalDateTime endTime) {
        log.info("getBetween");
        List<Meal> meals = service.getAllByUser(AuthorizedUser.id());
